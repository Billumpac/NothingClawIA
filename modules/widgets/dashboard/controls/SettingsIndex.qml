...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        { label: "AI Agent Connections", keywords: "mcp openclaw agent tool external server bridge", section: 3, subSection: "", subLabel: "AI", icon: Icons.robot, isIcon: true },
        { label: "AI Tools", keywords: "shell command tool safety allowlist auto-approve", section: 3, subSection: "", subLabel: "AI", icon: Icons.toolbox, isIcon: true },
        { label: "AI API Keys", keywords: "openai gemini mistral anthropic groq deepseek key", section: 3, subSection: "", subLabel: "AI", icon: Icons.keyboard, isIcon: true },
